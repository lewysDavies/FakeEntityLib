...
public class EntityIdProvider1_18 implements EntityIdProvider {
    ...
    static {
        try {
            entityCountField = ReflectionUtil.getClass("net.minecraft.world.entity.Entity").getDeclaredField("c");
